...
func _physics_process(_delta):
	...
	if !Global.paused : 
		...
		if Input.is_action_just_pressed("ui_select_gun1") and gunIndex != gunSelector.GUN0 :
			gunIndex = gunSelector.GUN0
			_set_gun()
		if Global.gun2Unlocked and Input.is_action_just_pressed("ui_select_gun2") and gunIndex != gunSelector.GUN1 :
			gunIndex = gunSelector.GUN1
			_set_gun()
		if Global.gun3Unlocked and Input.is_action_just_pressed("ui_select_gun3") and gunIndex != gunSelector.GUN2 :
