...
@onready var playerMarker = get_node("Marker2D")
@onready var healthBar = get_node("Healthbar")

var entered : bool 
var speed : int = 150 # oli 100
var direction : Vector2
var collision
var health : float = 350

var damageToPlayer = 40
...
func _physics_process(delta):
	...
	while playerMarker.global_position.distance_to(player.global_position) <= 100 :
